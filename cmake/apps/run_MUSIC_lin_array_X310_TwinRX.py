...
class run_MUSIC_lin_array_X310_TwinRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.relative_phase_offset = relative_phase_offset = "IIO_FMCOMMS5_relative_phase_offsets.txt"
        ...
        self.connect((self.CARES_phase_correct_hier_0, 3), (self.aoa_autocorrelate_0, 3))
        ...
        self.connect((self.CARES_phase_correct_hier_0, 2), (self.aoa_autocorrelate_0, 2))
