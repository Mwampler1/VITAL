...
class IIO_FMCOMMS5_find_doa_without_anetenna_calibration(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "IIO_FMCOMMS5_find_doa_without_anetenna_calibration")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("IIO_FMCOMMS5_find_doa_without_anetenna_calibration")
        ...
        self.settings = Qt.QSettings("GNU Radio", "IIO_FMCOMMS5_find_doa_without_anetenna_calibration")
...
def main(top_block_cls=IIO_FMCOMMS5_find_doa_without_anetenna_calibration, options=None):
