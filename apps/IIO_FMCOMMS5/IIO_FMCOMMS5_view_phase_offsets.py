...
# Title: IIO_FMCOMMS5_view_phase_offsets
# Author: megan
...
class IIO_FMCOMMS5_view_phase_offsets(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "IIO_FMCOMMS5_view_phase_offsets")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("IIO_FMCOMMS5_view_phase_offsets")
        ...
        self.settings = Qt.QSettings("GNU Radio", "IIO_FMCOMMS5_view_phase_offsets")
        ...
        self.connect((self.blocks_float_to_complex_0_0_0, 0), (self.qtgui_time_sink_x_0, 2))
        self.connect((self.blocks_float_to_complex_0_0_0_0, 0), (self.qtgui_time_sink_x_0, 3))
...
def main(top_block_cls=IIO_FMCOMMS5_view_phase_offsets, options=None):
